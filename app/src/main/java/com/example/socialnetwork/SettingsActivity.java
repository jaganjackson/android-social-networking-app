...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void ValidateAccountInfo() {
        ...
        if(TextUtils.isEmpty(username)){
            ...
            Toast.makeText(SettingsActivity.this,"Profilename is empty",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(status)){
            Toast.makeText(SettingsActivity.this,"Status is empty",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(dob)){
            Toast.makeText(SettingsActivity.this,"Dob is empty",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(country)){
            Toast.makeText(SettingsActivity.this,"Country is empty",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(gender)){
            Toast.makeText(SettingsActivity.this,"Gender is empty",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(relation)){
            Toast.makeText(SettingsActivity.this,"Relation is empty",Toast.LENGTH_SHORT).show();
        }
        else {
            loadingBar.setTitle("Updating account information");
            loadingBar.setMessage("Please wait, while we updating your account information...");
            loadingBar.setCanceledOnTouchOutside(true);
            loadingBar.show();
        ...
        settingsuserRef.updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(SettingsActivity.this,"Settings are updated successfully",Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
                else {
                    Toast.makeText(SettingsActivity.this,"Settings updation failed",Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
        });
